...
<div class="col-md-12">
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".pharmacist-modal">Add Pharmacist</button>

    <div class="modal fade pharmacist-modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
