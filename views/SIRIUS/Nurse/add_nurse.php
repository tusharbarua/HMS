...
<div class="col-md-12">
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".nurse-modal">Add Nurse</button>

    <div class="modal fade nurse-modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
