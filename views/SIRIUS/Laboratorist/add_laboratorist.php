...
<div class="col-md-12">
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".laboratorist-modal">Add Laboratorist</button>


    <div class="modal fade laboratorist-modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
