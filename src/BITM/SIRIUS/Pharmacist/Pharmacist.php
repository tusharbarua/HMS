...
class Pharmacist extends DB
{
    ...
    public function store() {
        ...
        $query="INSERT INTO `hms_sirius`.`pharmacist` (`name`, `email`, `password`, address, phone, propic) VALUES (:name, :email, :password,:address, :phone, :propic)";
    ...
    public function change_password(){
        $query="UPDATE `hms_sirius`.`pharmacist` SET `password`=:password  WHERE `pharmacist`.`email` =:email";
    ...
    public function view(){
        $query=" SELECT * FROM pharmacist WHERE email = '$this->email' ";
        // Utility::dd($query);
    ...
    /*
        public function validTokenUpdate(){
            $query="UPDATE `hms_sirius`.`pharmacist` SET  `email_verified`='".'Yes'."' WHERE `users`.`email` ='$this->email'";
            $result=$this->DBH->prepare($query);
            $result->execute();
    ...
    */
    public function update(){
        ...
        $query="UPDATE `hms_sirius`.`pharmacist` SET `email` =:email, `phone` = :phone, `address` = :address  WHERE `users`.`email` = :email";
