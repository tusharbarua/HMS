...
class Nurse extends DB
{
    ...
    public function store() {
        ...
        $query="INSERT INTO `hms_sirius`.`nurse` (`name`, `email`, `password`, address, phone, propic) VALUES (:name, :email, :password,:address, :phone, :propic)";
    ...
    public function change_password(){
        $query="UPDATE `hms_sirius`.`nurse` SET `password`=:password  WHERE `nurse`.`email` =:email";
    ...
    public function view(){
        $query=" SELECT * FROM nurse WHERE email = '$this->email' ";
        // Utility::dd($query);
    ...
    /*
        public function validTokenUpdate(){
            $query="UPDATE `hms_sirius`.`nurse` SET  `email_verified`='".'Yes'."' WHERE `users`.`email` ='$this->email'";
            $result=$this->DBH->prepare($query);
            $result->execute();
    ...
    */
    public function update(){
        ...
        $query="UPDATE `hms_sirius`.`nurse` SET `email` =:email, `phone` = :phone, `address` = :address  WHERE `nurse`.`email` = :email";
