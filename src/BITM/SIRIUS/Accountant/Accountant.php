...
class Accountant extends DB
{
    ...
    public function store() {
        ...
        $query="INSERT INTO `hms_sirius`.`accountant` (`name`, `email`, `password`, address, phone, propic) VALUES (:name, :email, :password,:address, :phone, :propic)";
    ...
    public function change_password(){
        $query="UPDATE `hms_sirius`.`accountant` SET `password`=:password  WHERE `accountant`.`email` =:email";
    ...
    public function view(){
        $query=" SELECT * FROM accountant WHERE email = '$this->email' ";
        // Utility::dd($query);
    ...
    */
    public function update(){
        ...
        $query="UPDATE `hms_sirius`.`accountant` SET `email` =:email, `phone` = :phone, `address` = :address  WHERE `users`.`email` = :email";
