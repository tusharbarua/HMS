...
class Laboratorist extends DB
{
    ...
    public function store() {
        ...
        $query="INSERT INTO `hms_sirius`.`laboratorist` (`name`, `email`, `password`, address, phone, propic) VALUES (:name, :email, :password,:address, :phone, :propic)";
    ...
    public function change_password(){
        $query="UPDATE `hms_sirius`.`laboratorist` SET `password`=:password  WHERE `laboratorist`.`email` =:email";
    ...
    public function view(){
        $query=" SELECT * FROM laboratorist WHERE email = '$this->email' ";
        // Utility::dd($query);
    ...
    /*
        public function validTokenUpdate(){
            $query="UPDATE `hms_sirius`.`laboratorist` SET  `email_verified`='".'Yes'."' WHERE `users`.`email` ='$this->email'";
            $result=$this->DBH->prepare($query);
            $result->execute();
    ...
    */
    public function update(){
        ...
        $query="UPDATE `hms_sirius`.`laboratorist` SET `email` =:email, `phone` = :phone, `address` = :address  WHERE `laboratorist`.`email` = :email";
